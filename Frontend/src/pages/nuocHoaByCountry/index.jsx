...
const ListNuocHoa = () => {
    ...
    const getInitialParams = () => {
        const params = new URLSearchParams(window.location.search);
        const countryIdParam = params.get("countryId");
        ...
        return {
            ...
            countryId: countryIdParam ? parseInt(countryIdParam, 10) : "", 
    ...
    const countryIdFromNav = location.state?.countryId || "";
    const countryNameFromNav = location.state?.countryName || "";
    const [countryId, setCountryId] = useState(countryIdFromNav);
    const [countryName, setCountryName] = useState(countryNameFromNav);
    ...
    const [filters, setFilters] = useState({
        ...
        countryId: initialParams.countryId|| countryIdFromNav,
    ...
    useEffect(() => {
        if (location.state?.countryId) {
            ...
            setFilters(prev => ({ ...prev, countryId: location.state.countryId }));
        }
    }, [location.state?.countryId, location.state?.countryName]);   
    ...
    const updateUrlParams = (params) => {
        ...
        if(params.brandId) url.searchParams.set('brandId', params.countryId);
    ...
    const fetchProducts = () => {
        ...
        if(filters.countryId) queryParams.countryId = filters.countryId;
    ...
    return (
        <div className="nuoc-hoa">
            <div className="breadcrumb">
                ...
                <span className="arrow"> &gt; </span>
                <span className="current">Nước hoa {countryName}</span>
                <hr className="divider" />
            </div>

            <h1 className="product-title">Nước hoa {countryName}</h1>
