...
import './style.scss';
import { unisexProducts } from "../../services/unisexProducts";
...
const NuocHoaUnisex = () => {
    ...
    const sortedPerfumes = () => {
        switch (sortOption) {
            ...
            case "highToLow":
                return [...filteredPerfumes].sort((a, b) => b.maxPrice - a.maxPrice);
            case "lowToHigh":
                return [...filteredPerfumes].sort((a, b) => a.maxPrice - b.maxPrice);
            default:
